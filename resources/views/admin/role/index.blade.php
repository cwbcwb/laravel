	...
	<table class="table table-border table-bordered table-hover table-bg">
		...
		<tbody>
			...
			<tr class="text-c">
				...
				<td>{{$v->auth_ac}}</td>
				<td class="f-14">
				<a title="分配权限" href="javascript:;" onclick="admin_role_assign('分配权限','/Admin/role/assign','{{$v->id}}')" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
