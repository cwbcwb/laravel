...
<article class="page-container">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="type" class="input-text" autocomplete="off" value="" placeholder="" id="controller" name="controller">
		</div>
	</div>
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3">方法名称：</label>
		<div class="formControls col-xs-8 col-sm-9">
			<input type="type" class="input-text" autocomplete="off"  placeholder="" id="action" name="action">
		</div>
	</div>
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9 skin-minimal">
			<div class="radio-box">
				<input name="is_nav" type="radio" id="is_nav_1" value='1' checked >
				<label for="sex-1">是</label>
			</div>
			<div class="radio-box">
				<input type="radio" id="is_nav_2" name="is_nav" value='2'>
...
$(function(){
	...
	//做一个完善，当选择父级选择器时，不要让controller与action一起出来
