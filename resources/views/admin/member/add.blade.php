...
<article class="page-container">
	<form action="" method="post" class="form form-horizontal" id="form-member-add">
		...
		<div id="uploader-demo">
			<input type='hidden' name='avader' value=''/>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9"> <span class="select-box" style='width:110px;'>
				...
				<select id='city' class="select"  name="city" width='100'>
